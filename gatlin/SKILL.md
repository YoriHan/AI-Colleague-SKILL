---
name: growth-gtm-analytics
description: Gatlin 的增长数据与 GTM 分析技能 — 正确跑 Helio 的真实 DAU/活跃用户口径、用户使用场景分析、渠道/UTM 归因、异动检测，以及在数据/自动化结论对外发布前做核验。用于增长日报/周报、用户场景拆解、看板，以及「这个数字/状态可信吗」的把关。
---
